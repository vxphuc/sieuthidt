...
const ForgotPassword = () => {
  ...
  const sendOTP = async () => {
    try {
        ...
        "https://staging.chatapi.io.vn/kiem-tra-nguoi-va-tai-khoan",
        {
            method: "POST",
            headers: {
        ...
        if (res.ok) {
            ...
            alert("Số điện thoại không chính xác hoặc không tồn tại");
        }
    ...
    const verifyOTP = async () => {
        try {
            const res = await fetch(
            "https://staging.chatapi.io.vn/check-otp",
            {
                method: "POST",
                headers: {
                "Content-Type": "application/json"
    ...
    const changePassword = async () => {
        ...
        try {
            ...
            const res = await fetch(
            "https://staging.chatapi.io.vn/doi-mat-khau",
            {
                method: "PATCH",
                headers: {
                "Content-Type": "application/json",
            ...
            location.href = "/dang-nhap-dai-ly";
            }
    ...
    <div className={styles.container}>
        {showPopup && (
            <div className={styles.popupOverlay}>
                ...
                <button onClick={copyOTP} className={styles.copyBtn}>
                    Copy OTP
                </button>
